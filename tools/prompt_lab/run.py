...
MESSY_FA = "\n".join([
    m("آرش", "سلام داداش چطوری؟ دیشب اون پروژه رو دیدی ک فرستادم؟", 18, 1),
    m("نگار", "اره بابا دیدم خیلیییی باحال بود فقط یکم باگ داشت 😅", 18, 2),
    m("آرش", "کدوم باگ؟ من ک تست کردم اوکی بود رو سیستمم", 18, 3),
    m("نگار", "رو موبایل میزنه بهم میریزه. فردا حضوری حلش میکنیم", 18, 5),
    m("آرش", "اوکی پس فردا ساعت ۷ کافه همیشگی. جدی این deadline رو میرسیم؟", 18, 6),
    m("نگار", "میرسیم نترس. تو backend رو تموم کن من frontend رو میزنم", 18, 7),
    m("آرش", "ولی boss گفته اگه نرسیم پروژه کنسله ها", 18, 9),
    m("نگار", "وای استرس نده الان 😂 میرسیم گفتم بهت", 18, 10),
    m("آرش", "راستی پول اون سرور رو دادی؟ vless هنوز کار نمیکنه", 18, 12),
    m("نگار", "نه فردا میدم. برم بخوابم کلاس دارم صبح. شب بخیر اجی", 18, 14),
])
