...
MESSY_FA = "\n".join([
    m("[redacted]", "سلام داداش چطوری؟ دیشب اون پروژه رو دیدی ک فرستادم؟", 18, 1),
    m("[redacted]", "اره بابا دیدم خیلیییی باحال بود فقط یکم باگ داشت 😅", 18, 2),
    m("[redacted]", "کدوم باگ؟ من ک تست کردم اوکی بود رو سیستمم", 18, 3),
    m("[redacted]", "رو موبایل میزنه بهم میریزه. فردا حضوری حلش میکنیم", 18, 5),
    m("[redacted]", "اوکی پس فردا ساعت ۷ کافه همیشگی. جدی این deadline رو میرسیم؟", 18, 6),
    m("[redacted]", "میرسیم نترس. تو backend رو تموم کن من frontend رو میزنم", 18, 7),
    m("[redacted]", "ولی boss گفته اگه نرسیم پروژه کنسله ها", 18, 9),
    m("[redacted]", "وای استرس نده الان 😂 میرسیم گفتم بهت", 18, 10),
    m("[redacted]", "راستی پول اون سرور رو دادی؟ vless هنوز کار نمیکنه", 18, 12),
    m("[redacted]", "نه فردا میدم. برم بخوابم کلاس دارم صبح. شب بخیر اجی", 18, 14),
])
